...
namespace DakHome
{
    public partial class LocNotAvaRemove : Form
    {
        LocNotAvailable w = new LocNotAvailable();
        public LocNotAvaRemove()
        {
            InitializeComponent();
        }

        private void LocNotAvaRemove_Load(object sender, EventArgs e)
        {
            select();
            LodingComboLec();
        }
