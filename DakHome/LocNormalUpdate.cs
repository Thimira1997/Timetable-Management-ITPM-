...
namespace DakHome
{
    public partial class LocNormalUpdate : Form
    {
        public LocNormalUpdate()
        {
            InitializeComponent();
        }

        private void LocNormalUpdate_Load(object sender, EventArgs e)
        {
            LodingComboLec();
            select();
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd3 = new SqlCommand("update LocNomal set sessionID =@sID,location = @room where id = @id", con);
