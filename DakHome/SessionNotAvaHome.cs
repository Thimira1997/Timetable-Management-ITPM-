...
namespace DakHome
{
    public partial class SessionNotAvaHome : Form
    {
        public SessionNotAvaHome()
        {
            InitializeComponent();
        }
        ...
        private void NotAvilableHome_Load(object sender, EventArgs e)
        {
            LodingComboLec();
            select();
        }
        ...
        {
            openChildForm(new SessionNotAvaShow());
        }

        private void bunifuFlatButton2_Click(object sender, EventArgs e)
        {
            openChildForm(new SessionNotAvaAdd());
        }

        private void bunifuFlatButton4_Click(object sender, EventArgs e)
        {
            openChildForm(new SessionNotAvaRemove());
        }
        ...
        {
            openChildForm(new LocNotAvaAdd());
        }
        ...
        {
            openChildForm(new SessionNotAvaUpdate());
        }
