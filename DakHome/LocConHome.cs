...
namespace DakHome
{
    public partial class LocConHome : Form
    {
        public LocConHome()
        {
            InitializeComponent();
        ...
        {
            openChildForm(new LocConShow());
        }

        private void bunifuFlatButton2_Click(object sender, EventArgs e)
        {
            openChildForm(new LocConAdd());
        }

        private void bunifuFlatButton3_Click(object sender, EventArgs e)
        {
            openChildForm(new LocConUpdate());
        }

        private void bunifuFlatButton4_Click(object sender, EventArgs e)
        {
            openChildForm(new LocConRemove());
        }

        private void LocConHome_Load(object sender, EventArgs e)
        {
            LodingComboLec();
            select();
        }
