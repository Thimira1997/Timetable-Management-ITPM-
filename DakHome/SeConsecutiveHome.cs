...
namespace DakHome
{
    public partial class seconHome : Form
    {
        public seconHome()
        {
            InitializeComponent();
        ...
        {
            openChildForm(new SeConsecutiveAdd());
        }

        private void bunifuFlatButton1_Click(object sender, EventArgs e)
        {
            openChildForm(new SeConsecutiveShow());
        }

        private void bunifuFlatButton3_Click(object sender, EventArgs e)
        {
            openChildForm(new SeConsecutiveUpdate());
        }

        private void bunifuFlatButton4_Click(object sender, EventArgs e)
        {
            openChildForm(new SeConsecutiveRemove());
        }

        private void seconHome_Load(object sender, EventArgs e)
        {
            LodingComboLec();
            select();
        }
