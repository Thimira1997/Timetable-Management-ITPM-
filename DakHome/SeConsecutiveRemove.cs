...
namespace DakHome
{
    public partial class SeConsecutiveRemove : Form
    {
        Consecutive w = new Consecutive();
        public SeConsecutiveRemove()
        {
            InitializeComponent();
        }
        ...
        private void SeConsecutiveRemove_Load(object sender, EventArgs e)
        {
            LodingComboLec();
            select();
        }
