...
namespace DakHome
{
    public partial class SeNonOverRemove : Form
    {
        NonOverlaping n = new NonOverlaping();
        public SeNonOverRemove()
        {
            InitializeComponent();
        }
        ...
        private void SeNonOverRemove_Load(object sender, EventArgs e)
        {
            LodingComboLec();
            select();      
        }
